...
<section class="border-b border-adh-border py-6 dark:border-gray-700">
    <div class="rounded-[var(--adh-radius)] border border-adh-border/80 bg-slate-50/65 p-5 shadow-sm dark:border-gray-700 dark:bg-adh-blue/30">
        <div class="mb-5 flex flex-col gap-2 border-b border-adh-border/80 pb-4 dark:border-gray-700 md:flex-row md:items-end md:justify-between">
            <div>
            ...
            <p class="max-w-md text-xs leading-6 text-adh-gray dark:text-gray-400">
                {{ __('Hava durumu, nöbetçi eczane ve günlük yerel bilgiler tek akışta sunulur.') }}
            </p>
        </div>

        <div class="grid grid-cols-1 gap-5 xl:[grid-template-columns:repeat(auto-fit,minmax(18rem,1fr))]">
