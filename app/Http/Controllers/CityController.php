...
class CityController extends Controller
{
    public function show(string $slug)
    {
        ...
        abort_unless(in_array($slug, array_keys($allCities)), 404);
        ...
        return view('news.city', compact('cityName', 'slug', 'articles', 'allCities'))->with([
            'metaTitle'       => $cityName . ' Haberleri — Adıyaman Dijital Haber',
            'metaDescription' => $cityName . ' ilinden en güncel haberler.',
        ]);
    }
    ...
    public function index()
    {
        ...
        return view('news.cities', compact('allCities', 'cityCounts'))->with([
            'metaTitle'       => 'İller — Adıyaman Dijital Haber',
            'metaDescription' => 'Bölge illerinden en güncel haberler.',
        ]);
    }
}
